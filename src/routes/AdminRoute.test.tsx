...
function renderRoute(role: "USER" | "ADMIN" | "SUPER_ADMIN") {
  vi.mocked(useAuth).mockReturnValue({ user: { id: "user-1", email: "user@example.com", emailVerified: true, name: "User", role, settings: { company: "", signature: "", aiProvider: "MOCK", theme: "DARK", notifications: true } }, loading: false, login: vi.fn(), register: vi.fn(), acceptSession: vi.fn(), logout: vi.fn(), updateUser: vi.fn() });
