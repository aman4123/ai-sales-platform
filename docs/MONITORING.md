...
- Warn: p95 API latency above one second for fifteen minutes, sustained rate-limit spikes, SMTP failures, AI 502/503 spikes, database storage above 75%, or backup verification overdue.
